...
export function LoginModal({ isOpen, onClose, onSwitchToRegister, t }: { isOpen: boolean, onClose: () => void, onSwitchToRegister: () => void, t: any }) {
    ...
    const handleEmailLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError((err as Error).message || t.failedToLogin);
        } finally {
            setIsLoading(false);
        }
    };
                    ...
                    <div className="bg-white dark:bg-gray-800 py-8 px-4 shadow sm:rounded-lg sm:px-10 border border-gray-100 dark:border-gray-700">
                        <form className="space-y-6" onSubmit={handleEmailLogin}>
                            ...
                            <div>
                                ...
                                >
                                    {isLoading ? <Loader2 size={18} className="animate-spin" /> : t.signIn}
                                </button>
                            </div>
                        </form>
...
export function RegisterModal({ isOpen, onClose, onSwitchToLogin, t }: { isOpen: boolean, onClose: () => void, onSwitchToLogin: () => void, t: any }) {
                        ...
                        <form className="space-y-6" onSubmit={handleEmailRegister}>
                            ...
                            <div>
                                <button
                                    ...
                                    className="w-full flex justify-center items-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-amber-600 hover:bg-amber-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 transition-colors disabled:opacity-70"
                                >
                                    {isLoading ? <Loader2 size={18} className="animate-spin" /> : t.signUp}
                                </button>
                            </div>
                        </form>
